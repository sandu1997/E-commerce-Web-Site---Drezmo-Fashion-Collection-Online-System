...
<body>
   ...
   <!--  <div id="preloder">
            ...
            <div class="inner-header">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-7">
						...
						<font style="font-size:30px"><b>Admin Dashboard</b></font></center>
                    </div>
        ...
        <div class="nav-item">
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul>
                        <li class="active"><a href="admin.php?user_manager" >User Manage</a></li>
                        <li><a href="admin.php?transections">Transections</a></li>
                        <li><a href="admin.php?profile">Profile</a></li>
                    </ul>
                </nav>
	...
	<?php
		...
		if(isset($_GET['user_manager'])){
			include "usermanage.php";
		}elseif(isset($_GET['transections'])){
